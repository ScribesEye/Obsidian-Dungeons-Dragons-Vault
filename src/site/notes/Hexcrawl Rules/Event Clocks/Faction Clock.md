---
{"dg-publish":true,"permalink":"/hexcrawl-rules/event-clocks/faction-clock/"}
---

The Faction Clock is an [[Hexcrawl Rules/Event Clocks/Event Clocks\|Event Clock]] used in a[[Hexcrawl Rules/Rules & Glossary/Glossary/Hexcrawl\|Hexcrawl]] to simulate the actions of factions and their effects on the [[Hexcrawl Rules/Rules & Glossary/Glossary/Hexmap\|Hexmap]] while the players are exploring.
### Clock Cycle
The Faction Clock starts at 20 and counts down to 0 using a clock dice. Once the clock goes below zero an Event decided by the Event Dice is triggered, and the clock then resets to its starting value, starting a new *Clock Cycle*. Always roll the Event Dice at the start of a new clock cycle to allow players to gain clues about the upcoming event if they are exploring [[Hexcrawl Rules/Rules & Glossary/Glossary/Hex\|Hexes]] of the relevant faction. 
...
The Clock Dice is rolled when the party takes a Long Rest, regardless if it is successful or not.
### Core Mechanics
The Overclock and its Clock Dice has the following mechanics:
...
2. If the Clock _drops to or below 0_, an Encounter is triggered.  After the Encounter resolves, the clock resets.
3. If the Clock *equals 3 or below but above 0*, a Foreshadowing Event occurs.  (These are just omens/spoor/clues, more or less.)
### Event Dice
...
| 3     | [[Hexcrawl Rules/Factions/Faction Events/Hexcrawl Faction Raid\|Raid]]                                                                                  |
| 2     | [[Hexcrawl Rules/Factions/Faction Events/Hexcrawl Faction Exploration\|Hexcrawl Faction Exploration]]                                                                                 |
| **1** | [[Hexcrawl Rules/Factions/Faction Events/Hexcrawl Faction Deserters\|Deserters]] / [[Hexcrawl Rules/Factions/Faction Events/Hexcrawl Faction Skirmish\|Skirmish]] **(Reduce Clock Dice Size)** |
